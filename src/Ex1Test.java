...
class Ex1Test {
    ...
    public void testPolynomFromPoints() {
        double[] xx = {1.0, 3.0};
        double[] yy = {3.0, 7.0};
        double[] result = assignments.Ex1.Ex1.PolynomFromPoints(xx, yy);
     ...
     */
    void testF() {
        double fx0 = assignments.Ex1.Ex1.f(po1, 0);
        double fx1 = assignments.Ex1.Ex1.f(po1, 1);
        double fx2 = assignments.Ex1.Ex1.f(po1, 2);
        assertEquals(fx0, 2, assignments.Ex1.Ex1.EPS);
        assertEquals(fx1, 4, assignments.Ex1.Ex1.EPS);
        assertEquals(fx2, 6, assignments.Ex1.Ex1.EPS);
    }
    ...
    void testF2() {
        double x = Math.PI;
        double[] po12 = assignments.Ex1.Ex1.add(po1, po2);
        double f1x = assignments.Ex1.Ex1.f(po1, x);
        double f2x = assignments.Ex1.Ex1.f(po2, x);
        double f12x = assignments.Ex1.Ex1.f(po12, x);
        assertEquals(f1x + f2x, f12x, assignments.Ex1.Ex1.EPS);
    }
    ...
    void testMulDoubleArrayDoubleArray() {
        ...
        double[] p12 = assignments.Ex1.Ex1.mul(po1, po2);
        for (int i = 0; i < xx.length; i = i + 1) {
            double x = xx[i];
            double f1x = assignments.Ex1.Ex1.f(po1, x);
            double f2x = assignments.Ex1.Ex1.f(po2, x);
            double f12x = assignments.Ex1.Ex1.f(p12, x);
            assertEquals(f12x, f1x * f2x, assignments.Ex1.Ex1.EPS);
        }
    }
    ...
    public void testFromString() {
        ...
        String sp = assignments.Ex1.Ex1.poly(p);
        double[] p1 = assignments.Ex1.Ex1.getPolynomFromString(sp);
        double[] p2 = assignments.Ex1.Ex1.getPolynomFromString(sp2);
        boolean isSame1 = assignments.Ex1.Ex1.equals(p1, p);
        boolean isSame2 = assignments.Ex1.Ex1.equals(p2, p);
        if (!isSame1) {
            fail();
        }
        if (!isSame2) {
        ...
        assertEquals(sp, assignments.Ex1.Ex1.poly(p1));
    }
    ...
    public void testEquals() {
        ...
        double[][] d2 = {assignments.Ex1.Ex1.ZERO, {1 + Ex1.EPS / 2}, {1, 2}};
